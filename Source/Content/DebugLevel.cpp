...
void DebugLevel::Initialize()
{
	...
	cameras[0].Initialize( Vector2( 0.0f, 0.0f ), Vector2(WORLD_WIDTH*0.99f, WORLD_HEIGHT*0.985f ), WINDOW_WIDTH, WINDOW_HEIGHT );		 // Center-Center
	cameras[1].Initialize( Vector2( -WORLD_WIDTH, 0.0f ), Vector2(WORLD_WIDTH*0.99f, WORLD_HEIGHT*0.985f ), WINDOW_WIDTH, WINDOW_HEIGHT );	 // Left-Center
	cameras[2].Initialize( Vector2(WORLD_WIDTH, 0.0f ), Vector2(WORLD_WIDTH*0.99f, WORLD_HEIGHT*0.985f ), WINDOW_WIDTH, WINDOW_HEIGHT );	 // Right-Center
	...
	cameras[4].Initialize( Vector2( 0.0f, WORLD_HEIGHT), Vector2(WORLD_WIDTH*0.99f, WORLD_HEIGHT*0.985f ), WINDOW_WIDTH, WINDOW_HEIGHT );    // Center-Top
	...
	cameras[7].Initialize( Vector2( 0.0f, -WORLD_HEIGHT), Vector2(WORLD_WIDTH*0.99f, WORLD_HEIGHT*0.985f ), WINDOW_WIDTH, WINDOW_HEIGHT );	 // Center-Bottom
